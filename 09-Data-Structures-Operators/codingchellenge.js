...
printGoals('Davies', 'Muller', 'Lewandowski', 'Maulik');
...
// console.log('Avegrage ODDS: ', total);
...
for (const [key, value] of gameEvents) {
  ...
  console.log(
    `An ${value} happened, on ${avg / gameEvents.size}, every 9 minutes`
  );
} */
...
btn.addEventListener('click', () => {
  ...
  const data = function (name) {
    ...
    for (const [i, n] of splitName.entries()) {
