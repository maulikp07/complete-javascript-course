...
//   let dogsJ = dJ.slice(1, 3);
//   dogsJ.forEach(function (dog, i) {
//     console.log(
//       `Dog number ${i + 1} is ${
...
//   const dogToHuman = ages.map(age => (age <= 2 ? age * 2 : 16 + age * 4));
//   const oldDogs = dogToHuman.filter(age => age >= 18);
//   //   const average = oldDogs.reduce((acc, cur) => (acc += cur)) / oldDogs.length;
